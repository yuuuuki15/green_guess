...
export const quizData: QuizData = {
  ...
  questions: [
    ...
    },
    {
      ...
      difficulty: 'medium',
      question: {
        ja: '牛もも肉（赤身）100gの鉄分は2.7mg。同じ量を納豆で摂るには何g必要？',
        en: 'Lean beef has 2.7mg iron per 100g. How many grams of natto do you need?',
      },
      animal_food: {
        ja: '牛もも肉（赤身）',
        en: 'Lean beef (round)',
      ...
      tolerance: 10,
      comment: {
        ja: '約82g — 納豆約2パック分！実は納豆の鉄分は牛肉を上回ります（100gあたり3.3mg vs 2.7mg）。',
        en: 'About 82g — just 2 packs of natto! Natto actually contains more iron per 100g than beef (3.3mg vs 2.7mg).',
      },
      alternatives: [
        { name: { ja: '小松菜（生）', en: 'Komatsuna (raw)' }, nutrient_per_100g: 2.8 },
